...
export const estimators = [
    ...
    { text: 'Calcule la proporción ensambles realizados en relación a los solicitados.', done: 0 },
    {
    ...
    { text: 'Tiempo promedio de Permanencia en cola (para cada cola)', done: 0 },
    ...
    { text: 'Cantidad de ensambles por hora y cantidad promedio de ensambles por hora.', done: 0 },
    {
        text: 'Indique cual es la probabilidad de haber completado 3 o más ensambles por hora. (este valor debería ser modificable)',
        done: 0,
    },
    { text: 'Debería poder simular al menos 10000 ensambles o 100000 eventos', done: 0 },
    {
